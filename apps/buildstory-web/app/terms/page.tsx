...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "AI narrative generation runs in one of four modes you choose: Local (a small model on your machine via Ollama), Bring Your Own Key (a cloud model you configure with your own API key, called directly from your machine), Cloud (an explicit, reviewed opt-in that routes redacted excerpts through Buildstory to our configured provider), or Off (no narrative generation at all). See the Privacy Policy for exactly what each mode sends and to whom.",
    ],
  },
  {
    heading: "3. Accounts",
  ...
  },
  {
    ...
    paragraphs: [
      "You can permanently delete your account and everything tied to it (profile, projects, scan snapshots and narrative text, published stories, comments, reactions, follow relationships) from Settings at any time. This is immediate and cannot be undone — see the Privacy Policy for exactly what is removed.",
    ],
  },
  {
  ...
  },
  {
    heading: "8. Pro",
    paragraphs: [
      "Pro is a tier with a higher monthly budget on the subsidized Cloud narrative path and access to a stronger cloud model on that path. It is free for every account at launch as a promotion; we may end that promotion with notice, at which point Pro benefits apply only to accounts that actually hold the Pro plan.",
      "Pro changes nothing about Local, Bring Your Own Key, or Off mode: scanning and generating narratives through those modes is unlimited on every tier, because that compute cost is yours, not ours. Every account, regardless of plan, is subject to a fair-use ceiling of 500 stored reports — an anti-abuse measure tied to our own storage cost, not a plan lever, and one that never applies to how much you can scan, only to how much stays stored on our servers.",
    ],
  },
  {
