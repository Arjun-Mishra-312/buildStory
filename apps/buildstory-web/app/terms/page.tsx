...
const sections: LegalSection[] = [
  ...
  },
  {
    heading: "8. Pro",
    paragraphs: [
      "Pro is a tier with a higher monthly budget on the subsidized Buildstory Cloud narrative path and a visible badge on your public profile. It is free for every account at launch as a promotion; we may end that promotion with notice, at which point Pro benefits apply only to accounts that actually hold the Pro plan.",
