  ...
  return (
    <section className="creator-page">
      ...
      <div className="settings-sections">
        ...
        <section><header><span className="section-index">02 / AI &amp; PRIVACY</span><h2>Choose where narrative work happens.</h2><p>Local mode keeps reviewed evidence on this machine. Cloud mode is an explicit opt-in.</p></header><OllamaModelStatus discoveryAvailable={isLocalApiEnabled()} cloudAvailable={cloudNarrativeAvailable(user.id)} /></section>
