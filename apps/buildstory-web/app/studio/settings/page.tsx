  ...
  return (
    <section className="creator-page">
      ...
      <div className="settings-sections">
        <section><header><span className="section-index">01 / PROFILE</span><h2>How builders find you.</h2><p>Your name, handle, and bio appear on published stories.</p></header><ProfileSettings handle={user.handle} displayName={user.displayName} bio={profile?.bio ?? ""} handleChangeAvailable={!user.handleChangedAt} /></section>
        <section><header><span className="section-index">02 / AI &amp; PRIVACY</span><h2>Choose where narrative work happens.</h2><p>Local mode keeps reviewed evidence on this machine. Cloud mode is an explicit opt-in.</p></header><OllamaModelStatus /></section>
