...
const POINTS: Record<NarrativeMode, DisclosurePoints> = {
  local: {
    ...
    leavesMachine: "Deterministic metrics, profile scores, and sanitized AI-written narrative prose. The scanner chooses a safe, balanced, or enhanced evidence profile from local RAM and logical CPU count (40, 64, or 80 excerpts). Selected excerpts travel only over loopback to Ollama; they are not uploaded to Buildstory or an external model provider.",
